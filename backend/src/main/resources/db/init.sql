...
-- 插入示例地点数据（使用 Picsum 随机图片）
INSERT INTO place (place_name, address, latitude, longitude, crowd_level, best_time, one_sentence, full_description, image_url, tips, suggested_duration) VALUES
('沙河公园湖边长椅', '南山区沙河西路', 22.5532, 113.9456, '低', '工作日下午', '下午三点有阳光，通常没人', '位于沙河公园北侧湖边，环境清幽，适合独自发呆或阅读。', 'https://picsum.photos/seed/shahe_park/400/300', '蚊虫较多，建议带驱蚊水', 90),
('南山图书馆角落', '南山区常兴路176号', 22.5331, 113.9231, '中', '全天', '靠窗位置能看到绿树', '图书馆三楼东侧有个安静的角落，靠窗可以看到外面的绿树，非常适合静心阅读。', 'https://picsum.photos/seed/nanshan_library/400/300', '需要保持安静，手机调静音', 120),
('华侨城创意园咖啡座', '南山区侨城东路', 22.5445, 113.9678, '中', '周末下午', '露天座位很惬意', '创意园内的露天咖啡座，周围都是绿植和艺术装置，适合放松心情。', 'https://picsum.photos/seed/oct_coffee/400/300', '周末人较多，建议早点去', 60);
...
ALTER TABLE place ADD COLUMN suggested_duration INT DEFAULT 60 COMMENT '建议游玩时长(分钟)';